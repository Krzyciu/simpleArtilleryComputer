...
[_vehicles] call FUNC(scanWeapons);
{
    _x params ["", "", "", "", "", ["_name", ""], ["_tooltip", ""]];
    _ctrlChargeList lbAdd _name;
    _ctrlChargeList lbSetTooltip [_forEachIndex, _tooltip];
} forEach GVAR(magModeData);
